 ...
 */
const PLANNING_BASE_PROMPT = `You are the planning component of **Nexus Coder**, an AI-powered CLI coding assistant developed by syngha.han, byeongju.lee, and young87.kim for Samsung.

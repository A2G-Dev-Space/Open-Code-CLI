...
> Original Document: [Tweet Analysis Agent](https://docs.agno.com/examples/use-cases/agents/tweet-analysis-agent.md)
> Category: other
> Downloaded: 2025-11-06T11:51:16.975Z
...
```python social_media_agent.py theme={null}

...
> Original Document: [Meeting Summarizer Agent](https://docs.agno.com/examples/use-cases/agents/meeting_summarizer_agent.md)
> Category: other
> Downloaded: 2025-11-06T11:51:16.932Z
...
```python cookbook/examples/agents/meeting_summarizer_agent.py theme={null}

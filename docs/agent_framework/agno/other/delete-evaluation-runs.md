...
> Original Document: [Delete Evaluation Runs](https://docs.agno.com/reference-api/schema/evals/delete-evaluation-runs.md)
> Category: other
> Downloaded: 2025-11-06T11:51:17.118Z
      ...
      application/json:
        schemaArray:
          - type: object
            ...
            refIdentifier: '#/components/schemas/DeleteEvalRunsRequest'
            requiredProperties:
              - eval_run_ids
        examples:
          example:

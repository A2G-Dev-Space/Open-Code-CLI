...
> Original Document: [vLLM Embedder](https://docs.agno.com/concepts/knowledge/embedder/vllm.md)
> Category: other
> Downloaded: 2025-11-06T11:51:13.696Z
...
```python vllm_embedder_remote.py theme={null}

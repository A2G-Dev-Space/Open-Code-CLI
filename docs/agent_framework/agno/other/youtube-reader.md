...
> Original Document: [YouTube Reader](https://docs.agno.com/examples/concepts/knowledge/readers/youtube/youtube-reader.md)
> Category: other
...
```python examples/concepts/knowledge/readers/youtube_reader_sync.py theme={null}

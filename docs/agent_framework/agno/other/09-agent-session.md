...
> Original Document: [Agent Session](https://docs.agno.com/examples/getting-started/09-agent-session.md)
> Category: other
> Downloaded: 2025-11-06T11:51:15.307Z
...
```python agent_session.py theme={null}
import json

...
> Original Document: [Readme Generator](https://docs.agno.com/examples/use-cases/agents/readme_generator.md)
> Category: other
> Downloaded: 2025-11-06T11:51:16.930Z
...
```python cookbook/examples/agents/readme_generator.py theme={null}

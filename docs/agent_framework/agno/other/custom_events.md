...
> Original Document: [Custom Events](https://docs.agno.com/examples/concepts/agent/events/custom_events.md)
> Category: other
> Downloaded: 2025-11-06T11:51:14.320Z
...
```python custom_events.py theme={null}
import asyncio

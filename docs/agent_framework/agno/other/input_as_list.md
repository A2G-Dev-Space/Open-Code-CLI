...
> Original Document: [Agent Input as List](https://docs.agno.com/examples/concepts/agent/input_and_output/input_as_list.md)
> Category: other
> Downloaded: 2025-11-06T11:51:14.393Z
...
```python input_as_list.py theme={null}

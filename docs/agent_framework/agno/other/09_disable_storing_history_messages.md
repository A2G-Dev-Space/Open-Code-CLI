...
> Original Document: [Disable Storing History Messages](https://docs.agno.com/examples/concepts/agent/session/09_disable_storing_history_messages.md)
> Category: other
...
```python disable_storing_history_messages.py theme={null}
"""

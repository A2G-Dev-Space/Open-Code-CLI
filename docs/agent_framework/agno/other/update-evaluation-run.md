...
> Original Document: [Update Evaluation Run](https://docs.agno.com/reference-api/schema/evals/update-evaluation-run.md)
> Category: other
> Downloaded: 2025-11-06T11:51:17.139Z
      ...
      application/json:
        schemaArray:
          - type: object
            ...
            refIdentifier: '#/components/schemas/UpdateEvalRunRequest'
            requiredProperties:
              - name
        examples:
          example:

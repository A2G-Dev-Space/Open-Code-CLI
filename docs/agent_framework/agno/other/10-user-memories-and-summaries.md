...
> Original Document: [User Memories and Session Summaries](https://docs.agno.com/examples/getting-started/10-user-memories-and-summaries.md)
> Category: other
> Downloaded: 2025-11-06T11:51:15.313Z
...
```python user_memories.py theme={null}
import json

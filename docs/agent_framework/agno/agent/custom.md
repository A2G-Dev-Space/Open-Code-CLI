...
> Original Document: [Custom Middleware](https://docs.agno.com/agent-os/customize/middleware/custom.md)
> Category: agent
...
> Create and add your own middleware to AgentOS applications

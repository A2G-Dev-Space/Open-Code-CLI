...
> Original Document: [Agent Sessions](https://docs.agno.com/concepts/agents/sessions.md)
> Category: agent
> Downloaded: 2025-11-06T11:51:13.572Z
...
<Steps>
  <Step title="Session history example">
    ```python session_history.py theme={null}
    from agno.agent import Agent
    from agno.models.google.gemini import Gemini
    from agno.db.sqlite import SqliteDb

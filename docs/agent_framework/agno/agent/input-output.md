...
> Original Document: [Input and Output](https://docs.agno.com/concepts/agents/input-output.md)
> Category: agent
...
<Steps>
  <Step title="Structured Output example">
    ```python movie_agent.py theme={null}
...
<Steps>
  <Step title="Validating the input example">
    ```python validating_input_agent.py theme={null}
    from typing import List
...
<Steps>
  <Step title="Create the typesafe research agent">
    ```python typesafe_research_agent.py theme={null}
    from typing import List

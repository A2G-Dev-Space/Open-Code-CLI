...
> Original Document: [Notion Knowledge Manager](https://docs.agno.com/examples/use-cases/workflows/notion-knowledge-manager.md)
> Category: workflows
> Downloaded: 2025-11-06T11:51:17.019Z

---

# Notion Knowledge Manager

> A workflow that manages knowledge in Notion database.

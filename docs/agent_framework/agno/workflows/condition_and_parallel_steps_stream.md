...
> Original Document: [Condition and Parallel Steps Workflow](https://docs.agno.com/examples/concepts/workflows/02-workflows-conditional-execution/condition_and_parallel_steps_stream.md)
> Category: workflows

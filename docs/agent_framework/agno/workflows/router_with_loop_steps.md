...
> Original Document: [Router with Loop Steps Workflow](https://docs.agno.com/examples/concepts/workflows/05_workflows_conditional_branching/router_with_loop_steps.md)
> Category: workflows

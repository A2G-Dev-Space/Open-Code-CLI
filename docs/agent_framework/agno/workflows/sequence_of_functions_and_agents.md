...
> Original Document: [Sequence of functions and agents](https://docs.agno.com/examples/concepts/workflows/01-basic-workflows/sequence_of_functions_and_agents.md)
> Category: workflows

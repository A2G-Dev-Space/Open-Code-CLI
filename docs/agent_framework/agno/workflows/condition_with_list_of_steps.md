...
> Original Document: [Condition with list of steps](https://docs.agno.com/examples/concepts/workflows/02-workflows-conditional-execution/condition_with_list_of_steps.md)
> Category: workflows
> Downloaded: 2025-11-06T11:51:15.245Z

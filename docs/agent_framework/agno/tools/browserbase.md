...
> Original Document: [Browserbase](https://docs.agno.com/concepts/tools/toolkits/web_scrape/browserbase.md)
> Category: tools
> Downloaded: 2025-11-06T11:51:14.131Z
...
```python cookbook/tools/browserbase_tools.py theme={null}

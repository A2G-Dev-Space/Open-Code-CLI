...
> Original Document: [Meeting Summary Agent](https://docs.agno.com/examples/concepts/tools/models/openai/meeting-summarizer.md)
> Category: tools
> Downloaded: 2025-11-06T11:51:15.134Z
...
```python ref/meeting_summarizer_agent.py theme={null}

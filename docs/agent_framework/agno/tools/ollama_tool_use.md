...
> Original Document: [Tool Use](https://docs.agno.com/examples/models/ollama/tool_use.md)
> Category: tools
> Downloaded: 2025-11-06T11:51:16.651Z
...
```python cookbook/models/ollama/tool_use.py theme={null}

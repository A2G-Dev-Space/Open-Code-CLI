...
> Original Document: [Advanced Imagen Tool with Vertex AI](https://docs.agno.com/examples/models/gemini/imagen_tool_advanced.md)
> Category: tools
...
```python cookbook/models/google/gemini/imagen_tool_advanced.py theme={null}

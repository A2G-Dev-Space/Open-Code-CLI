...
> Original Document: [Confirmation Required with Multiple Tools](https://docs.agno.com/examples/concepts/agent/human_in_the_loop/confirmation_required_multiple_tools.md)
> Category: tools

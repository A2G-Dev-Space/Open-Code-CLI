...
> Original Document: [Agent with Tools Stream](https://docs.agno.com/examples/models/llama_cpp/tool_use_stream.md)
> Category: tools
> Downloaded: 2025-11-06T11:51:15.987Z
...
```python cookbook/models/llama_cpp/tool_use_stream.py theme={null}

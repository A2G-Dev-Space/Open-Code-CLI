...
> Original Document: [Calculator](https://docs.agno.com/concepts/tools/toolkits/local/calculator.md)
> Category: tools
> Downloaded: 2025-11-06T11:51:13.930Z
...
```python cookbook/tools/calculator_tools.py theme={null}

...
> Original Document: [Async Agent with Tools](https://docs.agno.com/examples/models/vllm/async_tool_use.md)
> Category: tools
...
```python cookbook/models/vllm/async_tool_use.py theme={null}

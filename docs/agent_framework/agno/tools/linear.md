...
> Original Document: [Linear](https://docs.agno.com/concepts/tools/toolkits/others/linear.md)
> Category: tools
> Downloaded: 2025-11-06T11:51:14.004Z
...
```python cookbook/tools/linear_tools.py theme={null}

...
> Original Document: [DuckDb](https://docs.agno.com/concepts/tools/toolkits/database/duckdb.md)
> Category: tools
> Downloaded: 2025-11-06T11:51:13.916Z
...
```python cookbook/tools/duckdb_tools.py theme={null}

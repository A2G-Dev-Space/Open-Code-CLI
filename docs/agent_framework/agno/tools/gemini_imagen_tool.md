...
> Original Document: [Imagen Tool with OpenAI](https://docs.agno.com/examples/models/gemini/imagen_tool.md)
> Category: tools
> Downloaded: 2025-11-06T11:51:15.774Z
...
```python cookbook/models/google/gemini/imagen_tool.py theme={null}

...
> Original Document: [PgVector](https://docs.agno.com/examples/concepts/vectordb/pgvector/pgvector-db.md)
> Category: vector_db
...
```python cookbook/knowledge/vector_db/pgvector/pgvector_db.py theme={null}

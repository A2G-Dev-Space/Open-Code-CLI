...
> Original Document: [PgVector Hybrid Search](https://docs.agno.com/examples/concepts/vectordb/pgvector/pgvector-hybrid-search.md)
> Category: vector_db
> Downloaded: 2025-11-06T11:51:15.200Z
...
```python cookbook/knowledge/vector_db/pgvector/pgvector_hybrid_search.py theme={null}

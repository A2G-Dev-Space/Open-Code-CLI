...
> Original Document: [Couchbase](https://docs.agno.com/examples/concepts/vectordb/couchbase-db/couchbase-db.md)
> Category: vector_db
> Downloaded: 2025-11-06T11:51:15.161Z
...
```python cookbook/knowledge/vector_db/couchbase_db/couchbase_db.py theme={null}
import os

...
> Original Document: [SurrealDB](https://docs.agno.com/examples/concepts/vectordb/surrealdb/surreal-db.md)
> Category: vector_db
> Downloaded: 2025-11-06T11:51:15.212Z
...
```python cookbook/knowledge/vector_db/surrealdb/surreal_db.py theme={null}

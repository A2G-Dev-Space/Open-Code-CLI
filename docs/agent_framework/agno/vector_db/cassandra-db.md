...
> Original Document: [Cassandra](https://docs.agno.com/examples/concepts/vectordb/cassandra-db/cassandra-db.md)
> Category: vector_db
> Downloaded: 2025-11-06T11:51:15.147Z
...
```python cookbook/knowledge/vector_db/cassandra_db/cassandra_db.py theme={null}

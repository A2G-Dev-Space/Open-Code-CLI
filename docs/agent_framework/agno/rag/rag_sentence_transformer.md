...
> Original Document: [RAG with Sentence Transformer Reranker](https://docs.agno.com/examples/concepts/agent/rag/rag_sentence_transformer.md)
> Category: rag
> Downloaded: 2025-11-06T11:51:14.484Z
...
```python rag_sentence_transformer.py theme={null}

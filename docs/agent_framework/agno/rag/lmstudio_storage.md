...
> Original Document: [Agent with Storage](https://docs.agno.com/examples/models/lmstudio/storage.md)
> Category: rag
> Downloaded: 2025-11-06T11:51:16.294Z
...
```python cookbook/models/lmstudio/db.py theme={null}

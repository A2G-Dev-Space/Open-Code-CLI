...
> Original Document: [Recipe RAG Image Agent](https://docs.agno.com/examples/concepts/tools/models/openai/rag-recipe-image.md)
> Category: rag
...
```python ref/recipe_rag_image.py theme={null}

...
> Original Document: [Agent with Storage](https://docs.agno.com/examples/models/ibm/storage.md)
> Category: rag
> Downloaded: 2025-11-06T11:51:15.881Z
...
```python cookbook/models/ibm/watsonx/db.py theme={null}

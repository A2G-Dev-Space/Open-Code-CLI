...
> Original Document: [Structured Output](https://docs.agno.com/examples/models/langdb/structured_output.md)
> Category: models
> Downloaded: 2025-11-06T11:51:15.903Z
...
```python cookbook/models/langdb/structured_output.py theme={null}

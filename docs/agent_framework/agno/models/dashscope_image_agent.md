...
> Original Document: [Image Agent](https://docs.agno.com/examples/models/dashscope/image_agent.md)
> Category: models
> Downloaded: 2025-11-06T11:51:15.529Z
...
```python cookbook/models/dashscope/image_agent.py theme={null}

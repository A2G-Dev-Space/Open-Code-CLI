...
> Original Document: [Agent with Knowledge](https://docs.agno.com/examples/models/gemini/knowledge.md)
> Category: models
...
```python cookbook/models/google/gemini/knowledge.py theme={null}

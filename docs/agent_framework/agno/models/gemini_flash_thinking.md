...
> Original Document: [Flash Thinking Agent](https://docs.agno.com/examples/models/gemini/flash_thinking.md)
> Category: models
...
```python cookbook/models/google/gemini/flash_thinking_agent.py theme={null}

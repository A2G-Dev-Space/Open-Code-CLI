...
> Original Document: [Agent with Knowledge](https://docs.agno.com/examples/models/lmstudio/knowledge.md)
> Category: models
> Downloaded: 2025-11-06T11:51:15.994Z
...
```python cookbook/models/lmstudio/knowledge.py theme={null}

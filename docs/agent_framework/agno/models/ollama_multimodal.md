...
> Original Document: [Multimodal Agent](https://docs.agno.com/examples/models/ollama/multimodal.md)
> Category: models
> Downloaded: 2025-11-06T11:51:16.296Z
...
```python cookbook/models/ollama/image_agent_bytes.py theme={null}

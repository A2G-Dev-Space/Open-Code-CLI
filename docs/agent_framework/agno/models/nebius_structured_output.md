...
> Original Document: [Agent with Structured Outputs](https://docs.agno.com/examples/models/nebius/structured_output.md)
> Category: models
> Downloaded: 2025-11-06T11:51:16.164Z
...
```python cookbook/models/nebius/structured_output.py theme={null}

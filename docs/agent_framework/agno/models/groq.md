...
> Original Document: [Groq](https://docs.agno.com/concepts/models/groq.md)
> Category: models
> Downloaded: 2025-11-06T11:51:13.739Z
...
`Groq` extends the OpenAI-compatible interface and supports most parameters from the [OpenAI model](/concepts/models/openai).

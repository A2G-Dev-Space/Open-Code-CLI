...
> Original Document: [Image Bytes Input Agent](https://docs.agno.com/examples/models/mistral/image_bytes_input_agent.md)
> Category: models
> Downloaded: 2025-11-06T11:51:16.083Z
...
```python cookbook/models/mistral/image_bytes_input_agent.py theme={null}
import requests

...
> Original Document: [Image Generation Agent](https://docs.agno.com/examples/models/openai/responses/image_generation_agent.md)
> Category: models
> Downloaded: 2025-11-06T11:51:16.464Z
...
```python cookbook/models/openai/responses/image_generation_agent.py theme={null}

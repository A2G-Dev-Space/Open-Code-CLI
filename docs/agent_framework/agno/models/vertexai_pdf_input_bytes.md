...
> Original Document: [PDF Input Bytes Agent](https://docs.agno.com/examples/models/vertexai/claude/pdf_input_bytes.md)
> Category: models
...
<Steps>
  ...
  <Step title="Run Agent">
    <CodeGroup>
      ```bash Mac theme={null}
      python cookbook/models/vertexai/claude/pdf_input_bytes.py 
      ```

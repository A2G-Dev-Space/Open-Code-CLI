...
> Original Document: [Translation Agent](https://docs.agno.com/examples/models/groq/translation_agent.md)
> Category: models
...
```python cookbook/models/groq/translation_agent.py theme={null}
import base64

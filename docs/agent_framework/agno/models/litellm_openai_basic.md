...
> Original Document: [Basic Agent](https://docs.agno.com/examples/models/litellm_openai/basic.md)
> Category: models
> Downloaded: 2025-11-06T11:51:15.946Z
...
```python cookbook/models/litellm_openai/basic.py theme={null}

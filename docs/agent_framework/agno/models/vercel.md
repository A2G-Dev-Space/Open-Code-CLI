...
> Original Document: [Vercel v0](https://docs.agno.com/concepts/models/vercel.md)
> Category: models
> Downloaded: 2025-11-06T11:51:13.802Z
...
V0 extends the OpenAI-compatible interface and supports most parameters from the [OpenAI model](/concepts/models/openai).

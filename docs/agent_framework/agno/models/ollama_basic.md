...
> Original Document: [Basic](https://docs.agno.com/examples/models/ollama/basic.md)
> Category: models
> Downloaded: 2025-11-06T11:51:16.522Z
...
```python cookbook/models/ollama/basic.py theme={null}

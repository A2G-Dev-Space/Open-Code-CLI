...
> Original Document: [Agent with Structured Outputs](https://docs.agno.com/examples/models/cerebras_openai/structured_output.md)
> Category: models
> Downloaded: 2025-11-06T11:51:15.711Z
...
```python cookbook/models/cerebras_openai/structured_output.py theme={null}

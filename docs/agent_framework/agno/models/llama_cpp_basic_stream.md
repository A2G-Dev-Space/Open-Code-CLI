...
> Original Document: [Basic Stream](https://docs.agno.com/examples/models/llama_cpp/basic_stream.md)
> Category: models
> Downloaded: 2025-11-06T11:51:15.969Z
...
```python cookbook/models/llama_cpp/basic_stream.py theme={null}

...
> Original Document: [Autonomous Startup Team](https://docs.agno.com/examples/use-cases/teams/autonomous_startup_team.md)
> Category: teams
> Downloaded: 2025-11-06T11:51:16.989Z
...
```python cookbook/examples/teams/coordinate_mode/autonomous_startup_team.py theme={null}

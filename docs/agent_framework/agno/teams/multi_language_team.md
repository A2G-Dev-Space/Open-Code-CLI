...
> Original Document: [Multi Language Team](https://docs.agno.com/examples/use-cases/teams/multi_language_team.md)
> Category: teams
> Downloaded: 2025-11-06T11:51:17.012Z
...
```python cookbook/examples/teams/route_mode/multi_language_team.py theme={null}

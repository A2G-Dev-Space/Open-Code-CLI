...
> Original Document: [Team with Reasoning Tools](https://docs.agno.com/examples/concepts/reasoning/teams/reasoning-finance-team.md)
> Category: teams
...
```python cookbook/reasoning/teams/reasoning_finance_team.py theme={null}

...
> Original Document: [Route Mode Team Events](https://docs.agno.com/examples/concepts/teams/streaming/route_mode_events.md)
> Category: teams
...
```python cookbook/examples/teams/streaming/03_route_mode_events.py theme={null}
import asyncio

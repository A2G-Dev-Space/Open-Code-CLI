...
> Original Document: [Persistent Session with History Context](https://docs.agno.com/examples/concepts/teams/session/persistent_session_history.md)
> Category: teams
> Downloaded: 2025-11-06T11:51:15.079Z
...
```python cookbook/examples/teams/session/02_persistent_session_history.py theme={null}
"""

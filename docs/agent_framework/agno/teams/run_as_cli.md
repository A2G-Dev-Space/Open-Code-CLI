...
> Original Document: [Interactive CLI Writing Team](https://docs.agno.com/examples/concepts/teams/other/run_as_cli.md)
> Category: teams
> Downloaded: 2025-11-06T11:51:15.057Z
...
```python cookbook/examples/teams/basic/run_as_cli.py theme={null}

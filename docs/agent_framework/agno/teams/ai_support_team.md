...
> Original Document: [AI Support Team](https://docs.agno.com/examples/use-cases/teams/ai_support_team.md)
> Category: teams
> Downloaded: 2025-11-06T11:51:16.986Z
...
<Steps>
  ...
  <Step title="Run the agent">
    ```bash  theme={null}
    python cookbook/examples/teams/ai_customer_support_team.py
    ```
  </Step>
</Steps>

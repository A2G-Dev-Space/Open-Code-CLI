...
> Original Document: [Async Multi-Language Team](https://docs.agno.com/examples/concepts/teams/async/async_respond_directly.md)
> Category: teams
> Downloaded: 2025-11-06T11:51:14.954Z
...
```python cookbook/examples/teams/async/03_async_route.py theme={null}
"""

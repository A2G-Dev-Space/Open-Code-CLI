...
> Original Document: [Collaboration Team](https://docs.agno.com/examples/use-cases/teams/discussion_team.md)
> Category: teams
...
```python cookbook/examples/teams/collaborate_mode/collaboration_team.py theme={null}
import asyncio

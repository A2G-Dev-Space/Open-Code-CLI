...
> Original Document: [Async Coordinated Team](https://docs.agno.com/examples/concepts/teams/async/async_coordination_team.md)
> Category: teams
...
```python cookbook/examples/teams/async/02_async_coordinate.py theme={null}
import asyncio

...
> Original Document: [News Agency Team](https://docs.agno.com/examples/use-cases/teams/news_agency_team.md)
> Category: teams
> Downloaded: 2025-11-06T11:51:17.006Z
...
<Steps>
  ...
  <Step title="Run the agent">
    ```bash  theme={null}
    python cookbook/examples/teams/news_agency_team.py
    ```
  </Step>
</Steps>

...
> Original Document: [Memory](https://docs.agno.com/examples/models/ollama/memory.md)
> Category: memory
> Downloaded: 2025-11-06T11:51:16.316Z
...
```python cookbook/models/ollama/memory.py theme={null}
"""
